...
namespace Plutus.Expenses.Tests.CS
{
    ...
    public class ExpensesRepoTest
    {
        ...
        /// <summary>
        /// Failure path for the ExtractExpensesFromCsv method - Bad input CSV, return empty list
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Happy path for the GetExpenses method
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Test for the GetExpenses - Folder change functionality
        /// </summary>
        [TestMethod]
